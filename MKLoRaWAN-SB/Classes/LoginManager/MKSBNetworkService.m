...
@implementation MKSBCreateLoRaDeviceModel
...
@interface MKSBNetworkService ()

@property (nonatomic, strong)NSURLSessionDataTask *addLoRaDeviceTask;

@end

@implementation MKSBNetworkService

+ (instancetype)share {
    static dispatch_once_t t;
    static MKSBNetworkService *service = nil;
    dispatch_once(&t, ^{
        service = [[MKSBNetworkService alloc] init];
    });
    return service;
}

- (void)addLoRaDeviceToCloud:(MKSBCreateLoRaDeviceModel *)deviceModel
