...
static MKSBUserLoginManager *loginManager = nil;
static dispatch_once_t onceToken;

@interface MKSBUserLoginManager ()
...
+ (MKSBUserLoginManager *)shared {
    dispatch_once(&onceToken, ^{
        if (!loginManager) {
            loginManager = [MKSBUserLoginManager new];
        }
    });
    return loginManager;
}
