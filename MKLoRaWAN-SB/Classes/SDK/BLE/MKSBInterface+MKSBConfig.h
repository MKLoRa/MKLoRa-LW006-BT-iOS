...
/// Configure ephemeris update notification status.(LR1110)
/// @param start start
/// @param end end
/// @param sucBlock Success callback
/// @param failedBlock Failure callback
...
/// @param detection Man Down Detection.
/// @param start Notify Event On Man Down Start.
/// @param end Notify Event On Man Down End.
/// @param sucBlock Success callback
/// @param failedBlock Failure callback
