...
@interface MKSBPeripheral ()

@property (nonatomic, strong)CBPeripheral *peripheral;

@end

@implementation MKSBPeripheral
...
- (void)updateCharacterWithService:(CBService *)service {
    [self.peripheral sb_updateCharacterWithService:service];
}

- (void)updateCurrentNotifySuccess:(CBCharacteristic *)characteristic {
    [self.peripheral sb_updateCurrentNotifySuccess:characteristic];
}

- (BOOL)connectSuccess {
    return [self.peripheral sb_connectSuccess];
}

- (void)setNil {
    [self.peripheral sb_setNil];
}
