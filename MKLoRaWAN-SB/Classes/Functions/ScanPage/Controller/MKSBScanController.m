...
- (void)connectDeviceWithDataModel:(MKSBScanPageModel *)scanDataModel {
    ...
    [[MKSBConnectModel shared] connectDevice:scanDataModel.peripheral password:(scanDataModel.needPassword ? password : @"") deviceType:scanDataModel.deviceType sucBlock:^{
