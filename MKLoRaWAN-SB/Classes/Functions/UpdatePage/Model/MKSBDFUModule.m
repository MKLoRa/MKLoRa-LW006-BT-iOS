...
@interface MKSBDFUModule()<LoggerDelegate, DFUServiceDelegate, DFUProgressDelegate>
...
@implementation MKSBDFUModule

- (void)dealloc{
    NSLog(@"MKSBDFUModule销毁");
}
...
- (void)updateWithFileUrl:(NSString *)url
    ...
    self.dfuController = [initiator startWithTarget:[MKSBCentralManager shared].peripheral];
}
