...
@interface MKSBUpdateController ()<UITableViewDelegate,UITableViewDataSource>

@property (nonatomic, strong)MKBaseTableView *tableView;

@property (nonatomic, strong)NSMutableArray *dataList;

@property (nonatomic, strong)MKSBDFUModule *dfuModule;
...
@implementation MKSBUpdateController

- (void)dealloc {
    NSLog(@"MKSBUpdateController销毁");
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"mk_sb_startDfuProcessNotification" object:nil];
...
- (void)updateComplete {
    ...
    [MKSBCentralManager sharedDealloc];
    [[NSNotificationCenter defaultCenter] postNotificationName:@"mk_sb_centralDeallocNotification" object:nil];
...
- (MKSBDFUModule *)dfuModule {
    if (!_dfuModule) {
        _dfuModule = [[MKSBDFUModule alloc] init];
    }
    return _dfuModule;
}
