//
//  MKSBSosAlarmSettingsController.m
...
@interface MKSBSosAlarmSettingsController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKSBSosAlarmSettingsModel *dataModel;

@property (nonatomic, strong)NSMutableArray *headerList;

@end

@implementation MKSBSosAlarmSettingsController

- (void)dealloc {
    NSLog(@"MKSBSosAlarmSettingsController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKLoRaWAN-SB", @"MKSBSosAlarmSettingsController", @"sb_slotSaveIcon.png") forState:UIControlStateNormal];
...
- (MKSBSosAlarmSettingsModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKSBSosAlarmSettingsModel alloc] init];
    }
    return _dataModel;
}
