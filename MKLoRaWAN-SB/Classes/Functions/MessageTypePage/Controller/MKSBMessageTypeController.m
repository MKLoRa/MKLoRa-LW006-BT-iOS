...
@interface MKSBMessageTypeController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKSBMessageTypeModel *dataModel;

@end

@implementation MKSBMessageTypeController

- (void)dealloc {
    NSLog(@"MKSBMessageTypeController销毁");
}
...
- (void)mk_loraTextButtonCellSelected:(NSInteger)index
    ...
    if (index == 1) {
        ...
        cellModel.dataListIndex = dataListIndex;
        self.dataModel.deviceMaxTimes = dataListIndex;
        return;
    }
    if (index == 2) {
    ...
    if (index == 9) {
        ...
        cellModel.dataListIndex = dataListIndex;
        self.dataModel.gpsMaxTimes = dataListIndex;
        return;
    }
    if (index == 10) {
    ...
    if (index == 11) {
        ...
        cellModel.dataListIndex = dataListIndex;
        self.dataModel.positioningMaxTimes = dataListIndex;
        return;
    }
}
...
- (void)loadSection0Datas {
    ...
    cellModel1.dataListIndex = self.dataModel.deviceType;
    ...
    cellModel2.dataListIndex = self.dataModel.deviceMaxTimes;
...
- (void)loadSection4Datas {
    ...
    cellModel1.dataList = @[@"Unconfirmed",@"Confirmed"];
    cellModel1.dataListIndex = self.dataModel.gpsType;
    ...
    cellModel2.msg = @"Max Retransmission Times";
    cellModel2.dataList = @[@"0",@"1",@"2",@"3"];
    cellModel2.dataListIndex = self.dataModel.gpsMaxTimes;
...
- (void)loadSection5Datas {
    ...
    cellModel1.dataList = @[@"Unconfirmed",@"Confirmed"];
    cellModel1.dataListIndex = self.dataModel.positioningType;
    ...
    cellModel2.msg = @"Max Retransmission Times";
    cellModel2.dataList = @[@"0",@"1",@"2",@"3"];
    cellModel2.dataListIndex = self.dataModel.positioningMaxTimes;
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKLoRaWAN-SB", @"MKSBMessageTypeController", @"sb_slotSaveIcon.png") forState:UIControlStateNormal];
...
- (MKSBMessageTypeModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKSBMessageTypeModel alloc] init];
    }
    return _dataModel;
}
