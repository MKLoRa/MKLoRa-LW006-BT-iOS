...
@implementation MKSBAboutController

- (void)dealloc {
    NSLog(@"MKSBAboutController销毁");
}
...
- (UIImageView *)aboutIcon{
    if (!_aboutIcon) {
        ...
        _aboutIcon.image = LOADICON(@"MKLoRaWAN-SB", @"MKSBAboutController", @"sb_aboutIcon.png");
    }
    return _aboutIcon;
}
...
- (UIImageView *)bottomIcon {
    if (!_bottomIcon) {
        ...
        _bottomIcon.image = LOADICON(@"MKLoRaWAN-SB", @"MKSBAboutController", @"sb_aboutBottomIcon.png");
    }
    return _bottomIcon;
}
