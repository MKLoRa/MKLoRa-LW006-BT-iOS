...
@interface MKSBFilterByRawDataModel ()
...
@implementation MKSBFilterByRawDataModel
...
- (BOOL)readFilterByRawDataStatus {
    ...
    [MKSBInterface sb_readFilterTypeStatusWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
