//
//  MKSBFilterByBXPButtonController.m
...
@interface MKSBFilterByBXPButtonController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKSBFilterByBXPButtonModel *dataModel;

@property (nonatomic, strong)NSMutableArray *headerList;

@end

@implementation MKSBFilterByBXPButtonController

- (void)dealloc {
    NSLog(@"MKSBFilterByBXPButtonController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKLoRaWAN-SB", @"MKSBFilterByBXPButtonController", @"sb_slotSaveIcon.png") forState:UIControlStateNormal];
...
- (MKSBFilterByBXPButtonModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKSBFilterByBXPButtonModel alloc] init];
    }
    return _dataModel;
}
