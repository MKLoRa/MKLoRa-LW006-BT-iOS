...
- (BOOL)readFilterStatus {
    ...
    [MKSBInterface sb_readFilterByPirStatusWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configFilterStatus {
    __block BOOL success = NO;
    [MKSBInterface sb_configFilterByPirStatus:self.isOn sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readDelayStatus {
    __block BOOL success = NO;
    [MKSBInterface sb_readFilterByPirDelayResponseStatusWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configDelayStatus {
    __block BOOL success = NO;
    [MKSBInterface sb_configFilterByPirDelayResponseStatus:self.delayStatus sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readSensorSensitivity {
    __block BOOL success = NO;
    [MKSBInterface sb_readFilterByPirSensorSensitivityWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configSensorSensitivity {
    __block BOOL success = NO;
    [MKSBInterface sb_configFilterByPirSensorSensitivity:self.sensitivity sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readDetection {
    __block BOOL success = NO;
    [MKSBInterface sb_readFilterByPirDetectionStatusWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configDetection {
    __block BOOL success = NO;
    [MKSBInterface sb_configFilterByPirDetectionStatus:self.detection sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
