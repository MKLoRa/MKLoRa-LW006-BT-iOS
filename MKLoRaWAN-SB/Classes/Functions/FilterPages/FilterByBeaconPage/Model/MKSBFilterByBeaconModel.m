...
@interface MKSBFilterByBeaconModel ()
...
@implementation MKSBFilterByBeaconModel

- (void)readDataWithSucBlock:(void (^)(void))sucBlock failedBlock:(void (^)(NSError *error))failedBlock {
    if (self.pageType == mk_sb_filterByBeaconPageType_beacon) {
        [self readBeaconDataWithSucBlock:sucBlock failedBlock:failedBlock];
        return;
    }
    if (self.pageType == mk_sb_filterByBeaconPageType_bxpBeacon) {
...
- (BOOL)readBeaconFilterStatus {
    ...
    [MKSBInterface sb_readFilterByBeaconStatusWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configBeaconFilterStatus {
    __block BOOL success = NO;
    [MKSBInterface sb_configFilterByBeaconStatus:self.isOn sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readBeaconFilterMajor {
    __block BOOL success = NO;
    [MKSBInterface sb_readFilterByBeaconMajorRangeWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configBeaconFilterMajor {
    ...
    [MKSBInterface sb_configFilterByBeaconMajorMinValue:min maxValue:max sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readBeaconFilterMinor {
    __block BOOL success = NO;
    [MKSBInterface sb_readFilterByBeaconMinorRangeWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configBeaconFilterMinor {
    ...
    [MKSBInterface sb_configFilterByBeaconMinorMinValue:min maxValue:max sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readBeaconFilterUUID {
    __block BOOL success = NO;
    [MKSBInterface sb_readFilterByBeaconUUIDWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configBeaconFilterUUID {
    __block BOOL success = NO;
    [MKSBInterface sb_configFilterByBeaconUUID:self.uuid sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readBXPBeaconFilterStatus {
    __block BOOL success = NO;
    [MKSBInterface sb_readFilterByBXPBeaconStatusWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
        self.isOn = [returnData[@"result"][@"isOn"] boolValue];
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
...
- (BOOL)configBXPBeaconFilterStatus {
    __block BOOL success = NO;
    [MKSBInterface sb_configFilterByBXPBeaconStatus:self.isOn sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readBXPBeaconFilterMajor {
    __block BOOL success = NO;
    [MKSBInterface sb_readFilterByBXPBeaconMajorRangeWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
        self.minMajor = returnData[@"result"][@"minValue"];
        self.maxMajor = returnData[@"result"][@"maxValue"];
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)configBXPBeaconFilterMajor {
    ...
    [MKSBInterface sb_configFilterByBXPBeaconMajorMinValue:min maxValue:max sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readBXPBeaconFilterMinor {
    __block BOOL success = NO;
    [MKSBInterface sb_readFilterByBXPBeaconMinorRangeWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
        self.minMinor = returnData[@"result"][@"minValue"];
        self.maxMinor = returnData[@"result"][@"maxValue"];
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)configBXPBeaconFilterMinor {
    ...
    [MKSBInterface sb_configFilterByBXPBeaconMinorMinValue:min maxValue:max sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readBXPBeaconFilterUUID {
    __block BOOL success = NO;
    [MKSBInterface sb_readFilterByBXPBeaconUUIDWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
        self.uuid = returnData[@"result"][@"uuid"];
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
...
- (BOOL)configBXPBeaconFilterUUID {
    __block BOOL success = NO;
    [MKSBInterface sb_configFilterByBXPBeaconUUID:self.uuid sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
