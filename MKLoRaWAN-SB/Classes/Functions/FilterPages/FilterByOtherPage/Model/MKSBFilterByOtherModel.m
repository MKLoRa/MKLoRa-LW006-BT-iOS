...
@implementation MKSBFilterRawAdvDataModel
...
@interface MKSBFilterByOtherModel ()
...
@implementation MKSBFilterByOtherModel
...
- (void)configWithRawDataList:(NSArray <MKSBFilterRawAdvDataModel *>*)list
                 relationship:(mk_sb_filterByOther)relationship
...
- (BOOL)readFilterStatus {
    ...
    [MKSBInterface sb_readFilterByOtherStatusWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configFilterStatus {
    __block BOOL success = NO;
    [MKSBInterface sb_configFilterByOtherStatus:self.isOn sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readRelationship {
    __block BOOL success = NO;
    [MKSBInterface sb_readFilterByOtherRelationshipWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configRelationship:(NSInteger)relationship {
    __block BOOL success = NO;
    [MKSBInterface sb_configFilterByOtherRelationship:relationship sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readConditions {
    __block BOOL success = NO;
    [MKSBInterface sb_readFilterByOtherConditionsWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configConditions:(NSArray <MKSBFilterRawAdvDataModel *>*)list {
    __block BOOL success = NO;
    [MKSBInterface sb_configFilterByOtherConditions:list sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
