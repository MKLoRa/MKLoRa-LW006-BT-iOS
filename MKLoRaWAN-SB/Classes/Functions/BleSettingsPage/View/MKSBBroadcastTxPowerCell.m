...
@implementation MKSBBroadcastTxPowerCellModel
@end

@interface MKSBBroadcastTxPowerCell ()
...
@implementation MKSBBroadcastTxPowerCell

+ (MKSBBroadcastTxPowerCell *)initCellWithTableView:(UITableView *)tableView {
    MKSBBroadcastTxPowerCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKSBBroadcastTxPowerCellIdenty"];
    if (!cell) {
        cell = [[MKSBBroadcastTxPowerCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKSBBroadcastTxPowerCellIdenty"];
    }
    return cell;
}
...
- (void)txPowerSliderValueChanged {
    ...
    if ([self.delegate respondsToSelector:@selector(sb_txPowerValueChanged:)]) {
        [self.delegate sb_txPowerValueChanged:(NSInteger)self.slider.value];
    }
}
...
#pragma mark - setter
- (void)setDataModel:(MKSBBroadcastTxPowerCellModel *)dataModel {
    _dataModel = nil;
