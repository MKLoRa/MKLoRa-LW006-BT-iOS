...
@interface MKSBBleSettingsModel ()
...
@implementation MKSBBleSettingsModel
...
- (BOOL)readAdvName {
    ...
    [MKSBInterface sb_readDeviceNameWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configAdvName {
    __block BOOL success = NO;
    [MKSBInterface sb_configDeviceName:self.advName sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readAdvInterval {
    __block BOOL success = NO;
    [MKSBInterface sb_readAdvIntervalWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configAdvInterval {
    __block BOOL success = NO;
    [MKSBInterface sb_configAdvInterval:[self.interval integerValue] sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readBroadcastTimeout {
    __block BOOL success = NO;
    [MKSBInterface sb_readBroadcastTimeoutWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configBroadcastTimeout {
    __block BOOL success = NO;
    [MKSBInterface sb_configBroadcastTimeout:[self.timeout integerValue] sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readNeedPassword {
    __block BOOL success = NO;
    [MKSBInterface sb_readConnectationNeedPasswordWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configNeedPassword {
    __block BOOL success = NO;
    [MKSBInterface sb_configNeedPassword:self.needPassword sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readTxPower {
    __block BOOL success = NO;
    [MKSBInterface sb_readTxPowerWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configTxPower {
    __block BOOL success = NO;
    [MKSBInterface sb_configTxPower:self.txPower sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
