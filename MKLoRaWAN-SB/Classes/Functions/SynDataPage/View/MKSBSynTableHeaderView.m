...
@implementation MKSBMsgIconButton
...
@interface MKSBSynTableHeaderView ()
...
@property (nonatomic, strong)MKSBMsgIconButton *synButton;

@property (nonatomic, strong)MKSBMsgIconButton *emptyButton;

@property (nonatomic, strong)MKSBMsgIconButton *exportButton;
...
@implementation MKSBSynTableHeaderView
...
- (MKSBMsgIconButton *)synButton {
    if (!_synButton) {
        _synButton = [[MKSBMsgIconButton alloc] init];
        _synButton.topIcon.image = LOADICON(@"MKLoRaWAN-SB", @"MKSBSynTableHeaderView", @"sb_sync_enableIcon.png");
        _synButton.msgLabel.text = @"Sync";
    }
    return _synButton;
}

- (MKSBMsgIconButton *)emptyButton {
    if (!_emptyButton) {
        _emptyButton = [[MKSBMsgIconButton alloc] init];
        _emptyButton.topIcon.image = LOADICON(@"MKLoRaWAN-SB", @"MKSBSynTableHeaderView", @"sb_delete_enableIcon.png");
        _emptyButton.msgLabel.text = @"Empty";
    }
    return _emptyButton;
}

- (MKSBMsgIconButton *)exportButton {
    if (!_exportButton) {
        _exportButton = [[MKSBMsgIconButton alloc] init];
        _exportButton.topIcon.image = LOADICON(@"MKLoRaWAN-SB", @"MKSBSynTableHeaderView", @"sb_export_enableIcon.png");
