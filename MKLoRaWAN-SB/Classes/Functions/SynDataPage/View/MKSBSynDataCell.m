...
static NSString *const MKSBSynDataCellIdenty = @"MKSBSynDataCellIdenty";

@interface MKSBSynDataCell ()
...
@implementation MKSBSynDataCell

+ (MKSBSynDataCell *)initCellWithTableView:(UITableView *)tableView {
    MKSBSynDataCell *cell = [tableView dequeueReusableCellWithIdentifier:MKSBSynDataCellIdenty];
    if (!cell) {
        cell = [[MKSBSynDataCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:MKSBSynDataCellIdenty];
    }
    return cell;
}
