//
//  MKSBAlertAlarmSettingsController.m
...
@interface MKSBAlertAlarmSettingsController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKSBAlertAlarmSettingsModel *dataModel;

@property (nonatomic, strong)NSMutableArray *headerList;

@end

@implementation MKSBAlertAlarmSettingsController

- (void)dealloc {
    NSLog(@"MKSBAlertAlarmSettingsController销毁");
}
...
#pragma mark - UI
- (void)loadSubViews {
    self.defaultTitle = @"Alert Alarm Settings";
    [self.rightButton setImage:LOADICON(@"MKLoRaWAN-SB", @"MKSBAlertAlarmSettingsController", @"sb_slotSaveIcon.png") forState:UIControlStateNormal];
...
- (MKSBAlertAlarmSettingsModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKSBAlertAlarmSettingsModel alloc] init];
    }
    return _dataModel;
}
