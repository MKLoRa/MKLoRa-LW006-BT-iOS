...
@interface MKSBDownlinkController ()<UITableViewDelegate,
...
@implementation MKSBDownlinkController

- (void)dealloc {
    NSLog(@"MKSBDownlinkController销毁");
}
...
- (void)readDataFromDevice {
    ...
    [MKSBInterface sb_readDownlinkPositioningStrategyWithSucBlock:^(id  _Nonnull returnData) {
...
- (void)configDownlinkForPositioningStrategy:(NSInteger)strategy {
    ...
    [MKSBInterface sb_configDownlinkPositioningStrategy:strategy sucBlock:^{
        [[MKHudManager share] hide];
