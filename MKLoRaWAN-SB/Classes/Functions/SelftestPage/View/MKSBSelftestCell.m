...
@implementation MKSBSelftestCellModel
@end

@interface MKSBSelftestCell ()
...
@implementation MKSBSelftestCell

+ (MKSBSelftestCell *)initCellWithTableView:(UITableView *)tableView {
    MKSBSelftestCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKSBSelftestCellIdenty"];
    if (!cell) {
        cell = [[MKSBSelftestCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKSBSelftestCellIdenty"];
    }
    return cell;
}
...
#pragma mark - setter
- (void)setDataModel:(MKSBSelftestCellModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKSBSelftestCellModel.class]) {
        return;
    }
