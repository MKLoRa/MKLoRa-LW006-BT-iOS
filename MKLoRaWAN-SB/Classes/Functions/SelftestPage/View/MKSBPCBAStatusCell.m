...
@implementation MKSBPCBAStatusCellModel
@end

@interface MKSBPCBAStatusCell ()
...
@implementation MKSBPCBAStatusCell

+ (MKSBPCBAStatusCell *)initCellWithTableView:(UITableView *)tableView {
    MKSBPCBAStatusCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKSBPCBAStatusCellIdenty"];
    if (!cell) {
        cell = [[MKSBPCBAStatusCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKSBPCBAStatusCellIdenty"];
    }
    return cell;
}
...
#pragma mark - setter
- (void)setDataModel:(MKSBPCBAStatusCellModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKSBPCBAStatusCellModel.class]) {
        return;
    }
