...
@implementation MKSBMotionModeEventsModel
@end

@interface MKSBMotionModeModel ()
...
@implementation MKSBMotionModeModel
...
- (void)readDataWithSucBlock:(void (^)(void))sucBlock failedBlock:(void (^)(NSError *error))failedBlock {
    dispatch_async(self.readQueue, ^{
        ...
        if (![self readReportIntervalOnStationary]) {
...
- (void)configDataWithSucBlock:(void (^)(void))sucBlock failedBlock:(void (^)(NSError *error))failedBlock {
    dispatch_async(self.readQueue, ^{
        ...
        if (![self configReportIntervalOnStationary]) {
...
- (BOOL)readMotionModeEvents {
    ...
    [MKSBInterface sb_readMotionModeEventsWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
        ...
        self.fixOnStationaryState = [returnData[@"result"][@"fixOnStationaryState"] boolValue];
...
- (BOOL)configMotionModeEvents {
    __block BOOL success = NO;
    MKSBMotionModeEventsModel *eventModel = [[MKSBMotionModeEventsModel alloc] init];
    ...
    eventModel.fixOnStationaryState = self.fixOnStationaryState;
    [MKSBInterface sb_configMotionModeEvents:eventModel sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readNumberOfFixOnStart {
    __block BOOL success = NO;
    [MKSBInterface sb_readMotionModeNumberOfFixOnStartWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configNumberOfFixOnStart {
    __block BOOL success = NO;
    [MKSBInterface sb_configMotionModeNumberOfFixOnStart:[self.numberOfFixOnStart integerValue] sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readPosStrategyOnStart {
    __block BOOL success = NO;
    [MKSBInterface sb_readMotionModePosStrategyOnStartWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configPosStrategyOnStart {
    __block BOOL success = NO;
    [MKSBInterface sb_configMotionModePosStrategyOnStart:self.posStrategyOnStart sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readReportIntervalInTrip {
    __block BOOL success = NO;
    [MKSBInterface sb_readMotionModeReportIntervalInTripWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configReportIntervalInTrip {
    __block BOOL success = NO;
    [MKSBInterface sb_configMotionModeReportIntervalInTrip:[self.reportIntervalInTrip longLongValue] sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readPosStrategyInTrip {
    __block BOOL success = NO;
    [MKSBInterface sb_readMotionModePosStrategyInTripWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configPosStrategyInTrip {
    __block BOOL success = NO;
    [MKSBInterface sb_configMotionModePosStrategyInTrip:self.posStrategyInTrip sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readTripEndTimeout {
    __block BOOL success = NO;
    [MKSBInterface sb_readMotionModeTripEndTimeoutWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configTripEndTimeout {
    __block BOOL success = NO;
    [MKSBInterface sb_configMotionModeTripEndTimeout:[self.tripEndTimeout integerValue] sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readNumberOfFixOnEnd {
    __block BOOL success = NO;
    [MKSBInterface sb_readMotionModeNumberOfFixOnEndWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configNumberOfFixOnEnd {
    __block BOOL success = NO;
    [MKSBInterface sb_configMotionModeNumberOfFixOnEnd:[self.numberOfFixOnEnd integerValue] sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readReportIntervalOnEnd {
    __block BOOL success = NO;
    [MKSBInterface sb_readMotionModeReportIntervalOnEndWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configReportIntervalOnEnd {
    __block BOOL success = NO;
    [MKSBInterface sb_configMotionModeReportIntervalOnEnd:[self.reportIntervalOnEnd integerValue] sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readPosStrategyOnEnd {
    __block BOOL success = NO;
    [MKSBInterface sb_readMotionModePosStrategyOnEndWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configPosStrategyOnEnd {
    __block BOOL success = NO;
    [MKSBInterface sb_configMotionModePosStrategyOnEnd:self.posStrategyOnEnd sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readPosStrategyOnStationary {
    __block BOOL success = NO;
    [MKSBInterface sb_readMotionModePosStrategyOnStationaryWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configPosStrategyOnStationary {
    __block BOOL success = NO;
    [MKSBInterface sb_configMotionModePosStrategyOnStationary:self.posStrategyOnStationary sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readReportIntervalOnStationary {
    __block BOOL success = NO;
    [MKSBInterface sb_readMotionModeReportIntervalOnStationaryWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configReportIntervalOnStationary {
    __block BOOL success = NO;
    [MKSBInterface sb_configMotionModeReportIntervalOnStationary:[self.reportIntervalOnStationary integerValue] sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
