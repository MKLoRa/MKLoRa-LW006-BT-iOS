...
@implementation MKSBTextButtonCellModel
@end

@interface MKSBTextButtonCell ()
...
@implementation MKSBTextButtonCell

+ (MKSBTextButtonCell *)initCellWithTableView:(UITableView *)tableView {
    MKSBTextButtonCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKSBTextButtonCellIdenty"];
    if (!cell) {
        cell = [[MKSBTextButtonCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKSBTextButtonCellIdenty"];
    }
    return cell;
}
...
- (void)rightButtonPressed {
    if ([self.delegate respondsToSelector:@selector(sb_textButtonCell_buttonAction:)]) {
        [self.delegate sb_textButtonCell_buttonAction:self.dataModel.index];
    }
}

#pragma mark - setter
- (void)setDataModel:(MKSBTextButtonCellModel *)dataModel {
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKSBTextButtonCellModel.class]) {
        return;
    }
