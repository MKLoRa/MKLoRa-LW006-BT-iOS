...
@implementation MKSBDeviceInfoCellModel
...
@implementation MKSBDeviceInfoCell

+ (MKSBDeviceInfoCell *)initCellWithTableView:(UITableView *)tableView {
    MKSBDeviceInfoCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKSBDeviceInfoCellIdenty"];
    if (!cell) {
        cell = [[MKSBDeviceInfoCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKSBDeviceInfoCellIdenty"];
    }
    return cell;
}
...
#pragma mark - setter
- (void)setDataModel:(MKSBDeviceInfoCellModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKSBDeviceInfoCellModel.class]) {
        return;
    }
